# Import module from library umqtt.simple
...
# Define the topics
ttopic = b"geladeira/temperatura"  # Temperature Topic
htopic = b"geladeira/humidade"  # Humidity Topic
stopic = b"geladeira/status"  # Status Topic
ctopic = b"geladeira/command"  # Command Topic
mtopic = b"geladeira/monitor"  # Monitor Topic
